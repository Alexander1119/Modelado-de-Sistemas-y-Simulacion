...
public class Modelado {
    ...
    public double[][] regresionLineal(double[][] y,double[][] x){
         ...
         double[][] Betai;
         double[][] XXt_1=matriz.inversa(matriz.multiplicacionMatriz(matriz.transpuestaMatriz(x),x));
...
//
    ...
    public double[][] gamai(double[][] x,double[][] y){
        ...
        return matriz.multiplicacionMatriz(matriz.inversa(xx),yy);
    }
    ...
    public double[][] PiEstimado(double[][] x,double[][] y){
        ...
        return matriz.multiplicacionMatriz(matriz.inversa(matriz.multiplicacionMatriz(matriz.transpuestaMatriz(x),x)),matriz.multiplicacionMatriz(matriz.transpuestaMatriz(x),y));
    }
    ...
    public double[][] primeraecuacion(double[][] x,double[][] y){
        ...
        double[][] yestimados=matriz.multiplicacionMatriz(x,PiEstimado(x,y));
        for (int i=0;i<x.length;i++){
